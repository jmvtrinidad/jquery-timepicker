    ...
    var methods = {
        init: function (options) {
            return this.each(function () {
                ...
                if (settings.placeOnScroll) {
                    self.on('showTimepicker', function () {
                        var timeoutId;
                        $(document.body).on('DOMMouseScroll.time mousewheel.time scroll.time', function () {
                            window.clearTimeout(timeoutId);
                            timeoutId = window.setTimeout(function () {
                                if (self.timepicker('isVisible')) {
                                    self.timepicker('hide').timepicker('show');
                                }
                            }, settings.scrollThrottleTime);
                        });
                    });
                    self.on('hideTimepicker', function () {
                        $(document.body).off('DOMMouseScroll.time mousewheel.time scroll.time');
                    });
                }
            });
        },
